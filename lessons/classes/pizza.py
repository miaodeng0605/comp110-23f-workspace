...
"""Think of a class definition as a "roadmap" for objects that belong to the class you are defining the underlying structure every instance of this class will have"""


class Pizza:

    #attributes
    #Think of these as the varibales each instance of my class will have
    #<name> : <type>
    size: str
    toppings: int
    gluten_free: bool
    ...
    def price(self) -> float:
        """Method to alculate price of pizza"""
        if self.size == "large":
            price: float = 6.25
        else:
            price: float == 5.00
